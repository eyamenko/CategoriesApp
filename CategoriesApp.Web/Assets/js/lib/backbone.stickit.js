...
(function (factory) {
  ...
  Stickit.addHandler([{
    ...
    update: function($el, val, model, options) {
      ...
      // is pre-rendered and that we need to generate the bundles.
      if (!selectConfig) {
        selectConfig = {};
      ...
      if (optList instanceof Backbone.Collection) {
        ...
        // Listen to the bundles and trigger an update of the select options
        ...
        // Remove bundles event listeners once this binding is unstuck
      ...
      if (_.isArray(optList)) {
        ...
        // To define a select with optgroups, format selectOptions.bundles as an object
